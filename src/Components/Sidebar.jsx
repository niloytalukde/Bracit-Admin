  ...
  return (
    <div className="  p-4 space-y-4 w-74  h-screen shadow ">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h2 className="text-lg font-semibold"><span className="font-extrabold">S</span>tudent <span className="font-extrabold">L</span>ifecycle <span className="font-extrabold">M</span>anagement</h2>
        </div>
      </div>
